  ...
  return <section id="education" className="py-20 bg-muted/30">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          ...
          return <Card key={index} className="p-6 hover:shadow-hover transition-all duration-300 border-primary/20 hover:-translate-y-2 bg-card/80 backdrop-blur-sm">
                <div className="mb-4">
        ...
        <Card className="p-8 bg-gradient-to-br from-primary/5 to-accent/5 border-primary/20 max-w-3xl mx-auto">
          ...
          <button onClick={() => setShowCertificates(true)} className="flex items-center gap-2 text-accent font-medium hover:text-accent/80 transition-colors cursor-pointer">
        ...
        <Dialog open={showCertificates} onOpenChange={setShowCertificates}>
          <DialogContent className="max-w-2xl">
            ...
            <div className="grid gap-3 mt-4">
              {certificates.map((cert, index) => <div key={index} className="flex items-center justify-between p-4 border rounded-lg hover:bg-muted/50 transition-colors">
